            ...
            <p>
                <?php
                    if ($thisclient && is_object($thisclient) && $thisclient->isValid()
                        ...
                        ?>
                    <a id="home-links" href="<?php echo ROOT_PATH; ?>profile.php"><?php echo __('Profile'); ?></a> |
                    <a id="home-links" href="<?php echo ROOT_PATH; ?>tickets.php"><?php echo sprintf(__('Tickets <b>(%d)</b>'), $thisclient->getNumTickets()); ?></a> -
                    <a id="home-links" href="<?php echo $signout_url; ?>"><?php echo __('Sign Out'); ?></a>
                <?php
                    } elseif($nav) {
