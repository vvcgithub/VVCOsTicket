    ...
    <form action="account.php" method="post">
        ...
        <div>
            ...
            <p style="text-align: center;">
                <input type="submit" class="btn btn-primary" value="<?php echo __('Register'); ?>"/>
                <input type="button"vclass="btn btn-default" value="<?php echo __('Cancel'); ?>" onclick="javascript:
